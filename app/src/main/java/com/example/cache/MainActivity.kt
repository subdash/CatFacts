...
import com.example.cache.service.DBProxy
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showToastAtTop(context: Context, text: String) =
        Toast
        ...
        override fun onClick(v: View?) {
            ...
            ServiceInterface(this@MainActivity)
                ...
                .catch {
                    runOnUiThread {
                        this@MainActivity
                            .showToastAtTop(this@MainActivity, "Failed to retrieve data.")
                    }
                }
        }
    }
    ...
    inner class ClearButtonListener : View.OnClickListener {
        ...
        override fun onClick(v: View?) {
            this@MainActivity.let {
                it.dataTv.text = ""
                DBProxy
                    .getCacheQueries(this@MainActivity)
                    ?.deleteAllFromCache()
